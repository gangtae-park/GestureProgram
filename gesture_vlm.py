...
from vlm_pipeline.vlm_client import init_openai_client, warm_up_stream_client
from vlm_pipeline.ocr import init_ocr_reader
from vlm_pipeline.voice_server import start_voice_server_thread
from vlm_pipeline import depth as depth_module
...
def main():
    ...
    try:
        while True:
            ...
            # 3) Render both panes into the single combined window.
